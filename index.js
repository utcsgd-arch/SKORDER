...
const confirmationFinishBtn = document.getElementById('confirmation-finish-btn');
...
const editProductUomInput = document.getElementById('edit-product-uom');
...
function renderProducts(category) {
  ...
  productsToDisplay.forEach(product => {
    ...
    const quantityInputEl = card.querySelector('.product-quantity-input');
